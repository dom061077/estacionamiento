	...
	<body>
		...
		<div id="show-vehiculo" class="content scaffold-show" role="main">
			...
			<ol class="property-list vehiculo">
				...
				<g:if test="${vehiculoInstance?.observacion}">
				<li class="fieldcontain">
					<span id="observacion-label" class="property-label"><g:message code="vehiculo.observacion.label" default="Observacion" /></span>
					
						<span class="property-value" aria-labelledby="observacion-label"><g:fieldValue bean="${vehiculoInstance}" field="observacion"/></span>
